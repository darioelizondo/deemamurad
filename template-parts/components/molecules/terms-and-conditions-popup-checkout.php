<?php
    ...
    /**
     * Component: Molecule: Terms and Conditions Popup Checkout
     * 
...
<?php if( $terms_and_conditions_popup && !empty( $terms_and_conditions_popup[ 'content' ] ) ) : ?>
    <div id="termsConditionsPopupCheckout" class="terms-and-conditions-popup terms-and-conditions-popup-checkout">
        <div class="terms-and-conditions-popup__inner">
            ...
            <div class="terms-and-conditions-popup__wrapper-checkbox">
                <label class="terms-and-conditions-popup__label-checkbox">
                    <input type="checkbox" class="terms-and-conditions-popup__input terms-and-conditions-popup__input-checkbox" name="terms-and-conditions-popup-checkbox" id="termsAndConditionsCheckboxCheckout_understood" />
            ...
            <div class="terms-and-conditions-popup__wrapper-checkbox">
                <label class="terms-and-conditions-popup__label-checkbox">
                    <input type="checkbox" class="terms-and-conditions-popup__input terms-and-conditions-popup__input-checkbox" name="terms-and-conditions-popup-checkbox" id="termsAndConditionsCheckboxCheckout_readTerms" />
                    <span class="checkmark"></span>
                </label>
                <span class="terms-and-conditions-popup__checkbox-span">
            ...
            <div class="terms-and-conditions-popup__wrapper-button">
                <button class="terms-and-conditions-popup__button disabled" id="termsAndConditionsPopupButtonCheckout">Accept</button>
            </div>                
        </div>
    </div>
<?php endif; ?>
