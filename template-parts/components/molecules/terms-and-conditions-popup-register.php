<?php
    ...
    /**
     * Component: Molecule: Terms and Conditions Popup Register
     * 
...
<?php if( $terms_and_conditions_popup && !empty( $terms_and_conditions_popup[ 'content' ] ) ) : ?>
    <div id="termsConditionsPopupRegister" class="terms-and-conditions-popup terms-and-conditions-popup-checkout">
        <div class="terms-and-conditions-popup__inner">
            ...
            <div class="terms-and-conditions-popup__wrapper-checkbox">
                <label class="terms-and-conditions-popup__label-checkbox">
                    <input type="checkbox" class="terms-and-conditions-popup__input terms-and-conditions-popup__input-checkbox" name="terms-and-conditions-popup-checkbox" id="termsAndConditionsCheckboxRegister_understood" />
            ...
            <div class="terms-and-conditions-popup__wrapper-checkbox">
                <label class="terms-and-conditions-popup__label-checkbox">
                    <input type="checkbox" class="terms-and-conditions-popup__input terms-and-conditions-popup__input-checkbox" name="terms-and-conditions-popup-checkbox" id="termsAndConditionsCheckboxRegister_readTerms" />
                    <span class="checkmark"></span>
                </label>
                <span class="terms-and-conditions-popup__checkbox-span">
            ...
            <div class="terms-and-conditions-popup__wrapper-button">
                <button class="terms-and-conditions-popup__button disabled" id="termsAndConditionsPopupButtonRegister">Accept</button>
            </div>                
        </div>
    </div>
<?php endif; ?>
