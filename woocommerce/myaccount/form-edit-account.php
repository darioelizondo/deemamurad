...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		<label for="billing_birthday"><?php esc_html_e('Birth day', 'woocommerce'); ?></label>
		<input type="date" name="billing_birthday" id="billing_birthday" value="<?php echo esc_attr($birthday); ?>" class="woocommerce-Input woocommerce-Input--text input-text">
	</p>
